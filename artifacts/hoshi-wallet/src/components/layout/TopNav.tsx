      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Avatar className="w-10 h-10 border border-border">
            ...
            <AvatarFallback className="bg-primary/20 text-primary font-bold">{activeWallet?.name?.charAt(0) || "W"}</AvatarFallback>
          </Avatar>
          <div className="flex flex-col cursor-pointer">
            <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Active Wallet</span>
            <div className="flex items-center gap-1">
              <span className="text-sm font-semibold">{activeWallet?.name || "Loading..."}</span>
        ...
        <div className="flex items-center gap-3 text-muted-foreground">
          ...
          <div className="p-2 bg-card rounded-full cursor-pointer hover:text-primary transition-colors relative">
            ...
            <div className="absolute top-1.5 right-1.5 w-2 h-2 bg-primary rounded-full border-2 border-card"></div>
          </div>
          <Link href="/settings">
            <div className="p-2 bg-card rounded-full cursor-pointer hover:text-primary transition-colors">
